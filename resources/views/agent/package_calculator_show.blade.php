...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p><strong>GST Rate:</strong> {{ $calculation->gst_rate }}%</p>
            <p><strong>GST Amount:</strong> {{ $calculation->gst_amount }}</p>
            <p><strong>Total Price:</strong> ₹ {{ number_format($calculation->total_price) }}</p>
